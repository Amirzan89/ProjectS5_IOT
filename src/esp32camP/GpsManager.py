    ...
    def getGps(self):
        ...
        while gps_serial.any():
            try:
                ...
                for byte in data:
                    stat = MicropyGPS.update(chr(byte))
                    if stat is not None:
                        print('UTC Timestamp:', MicropyGPS.timestamp)
                        print('Date:', MicropyGPS.date_string('long'))
                        print('Latitude:', MicropyGPS.latitude_string())
                        print('Longitude:', MicropyGPS.longitude_string())
                        print('Altitude:', MicropyGPS.altitude)
                        print('Satellites in use:', MicropyGPS.satellites_in_use)
                        print('Horizontal Dilution of Precision:', MicropyGPS.hdop)
                        print()
